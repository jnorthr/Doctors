...
public class DoctorTemplateEngineTest1  extends GroovyTestCase 
{
    ...
    public void setUp() {
		...
		println "DoctorTemplateEngineTest setUp()"
    } // end of before
    ...
    void testBindingPresent() {
		println "DoctorTemplateEngineTest testBindingPresent()"
        assert binding != null
    }
    ...
    void testEnginePresent() {
		println "DoctorTemplateEngineTest testEnginePresent()"
        assert dr != null
...
'''.toString()
    ...
    {
		println "\n\nDoctorTemplateEngineTest testCreateTemplate() Test 2"
...
'''.toString()
    ...
    {
		println "\n\nDoctorTemplateEngineTest testCreateTemplate() Test 3"
...
'''.toString()
    ...
    {
		println "\n\nDoctorTemplateEngineTest testCreateTemplate() Test 4"
...
'''.toString()
    ...
    {
		println "\n\nDoctorTemplateEngineTest testCreateTemplate() Test 5"
...
'''.toString()
    ...
    {
		println "\n\nDoctorTemplateEngineTest testCreateTemplate() Test 6"
...
'''.toString()
    ...
    {
		println "\n\nDoctorTemplateEngineTest testCreateTemplate() Test 7"
        def source = '''= testCreateTemplate() Test 7
Community Documentation <Users@groovy.codehaus.org>
V1.1, 2014-08-01  2014-08-22
'''.toString()
		dr = new DoctorTemplateEngine();
        def output = dr.createTemplate(source).make()
        println "\n\n->.createTemplate(source).make() output w/o binding:\n|"+output.toString()+"|\n\nsource:\n|"+source+"|\n"
    ...
    {
		println "\n\nDoctorTemplateEngineTest testCreateTemplate() Test 8"
        def source = '''= testCreateTemplate() Test 8
Community Documentation <Users@groovy.codehaus.org>
V1.1, Dated 2014-08-17, 2014-08-17
'''.toString()
		dr = new DoctorTemplateEngine();
        def output = dr.createTemplate(source).make()
        println "\n\n->.createTemplate(source).make() output w/o binding:\n|"+output.toString()+"|\n\nsource:\n|"+source+"|\n"
    ...
    {
		println "\n\nDoctorTemplateEngineTest testCreateTemplate() Test 9"
...
/* causes out-of-memory */
    ...
    {
		println "\n\nDoctorTemplateEngineTest testCreateTemplate() Test 10"
...
'''.toString()
    ...
    {
		println "\n\nDoctorTemplateEngineTest testCreateTemplate() Test 11"
...
'''.toString()
    ...
    {
		println "\n\nDoctorTemplateEngineTest testCreateTemplate() Test 12"
        def source = '''= testCreateTemplate() Test 12
Community Documentation <Users@groovy.codehaus.org>
Version 1.1, 2014-08-02: Last Updated 2014-8-28, revision12
:linkcss:
...
'''.toString()
    ...
    {
		println "\n\nDoctorTemplateEngineTest testCreateTemplate() Test 13"
...
Hi {author}, said Bill.'''.toString()
    ...
    {
		println "\n\nDoctorTemplateEngineTest testCreateTemplate() Test 14"
...
'''.toString()
    ...
    {
		println "\n\nDoctorTemplateEngineTest testCreateTemplate() Test 15"
...
'''.toString()
    ...
    {
		println "\n\nDoctorTemplateEngineTest testCreateTemplate() Test 16"
...
'''.toString()
    ...
    {
		println "\n\nDoctorTemplateEngineTest testCreateTemplate() Test 17"
        def source = '''= testCreateTemplate() Test 17 - template with jsp include,
Community Documentation <Users@groovy.codehaus.org>
Version 1.1, 2014-08-02: Last Updated 2014-8-28, revision17
:linkcss:
...
'''.toString()
    ...
    {
		println "\n\nDoctorTemplateEngineTest testCreateTemplate() Test 18"
        def source = '''= testCreateTemplate() Test 18 - template with jsp missing include,
Community Documentation <Users@groovy.codehaus.org>
Version 1.1, 2014-08-02: Last Updated 2014-8-28, revision18
:linkcss:
...
'''.toString()
    ...
    {
		println "\n\nDoctorTemplateEngineTest testCreateTemplate() Test 19"
        def source = '''= testCreateTemplate() Test 19 - template with jsp included file exists,
Community Documentation <Users@groovy.codehaus.org>
Version 1.1, 2014-08-02: Last Updated 2014-8-28, revision19
:linkcss:
...
'''.toString()
    ...
    {
		println "\n\nDoctorTemplateEngineTest testCreateTemplate() Test 20"
...
'''.toString()
		...
		{
			println "DoctorTemplateEngineTest testCreateTemplate() Test 20 failed with message:"+any.message;
		}
    } // end of test class
    ...
    {
		println "\n\nDoctorTemplateEngineTest testCreateTemplate() Test 21"
        def source = '''= testCreateTemplate() Test 21 - template with asciidoctor include file exists,
Community Documentation <Users@groovy.codehaus.org>
Version 1.1, 2014-08-02: Last Updated 2014-8-28, revision21
:linkcss:
...
'''.toString()
    ...
    {
		println "\n\nDoctorTemplateEngineTest testCreateTemplate() Test 22"
        def source = '''= Servlets 3.0
Community Documentation <${name}@groovy.codehaus.org>
version 1.1, Written 2014-07-21 :  Rev.V1.1
:toc: left
:linkcss:
...
'''.toString()
    ...
    {
		println "\n\nDoctorTemplateEngineTest testCreateTemplate() Test 23"
        def source = '''include::war/complexsample.adoc[] 
