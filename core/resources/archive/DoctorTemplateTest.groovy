...
class DoctorTemplate extends spock.lang.Specification {
    DoctorTemplate test;
...
//	OutputCapture capture = new OutputCapture()
	...
	def cleanupSpec() 
	{
		println "end of testing for DoctorTemplate"
	}   
 
  	def "Build default DoctorTemplate"() {
  		when:     'default DoctorTemplate has been built'
		then:     test != null;
