 ...
 * ]
 * def engine = new groovy.text.AsciidocTemplateEngine2()
 * def text = '''\
 ...
 *     &lt;param-value&gt;groovy.text.AsciidocTemplateEngine2&lt;/param-value&gt;
 *   &lt;/init-param&gt;
 * &lt;/servlet&gt;
 * </pre>
 ...
 */
public class AsciidocTemplateEngine2 extends TemplateEngine 
{
    ...
    public AsciidocTemplateEngine2(ClassLoader parentLoader) {
        this(new GroovyShell(parentLoader));
    }

    public AsciidocTemplateEngine2(GroovyShell groovyShell) {
    ...
    {
	System.out.println("--- Start Of Text For AsciidocTemplateEngine2 ---");    
...
== Heading One
*This* is it. My name is {name}. Hi {author}. 

TIP: Eat Spinach regularly. 
icon:heart[2x] 
"""

	AsciidocTemplateEngine2 ate = new AsciidocTemplateEngine2();
...
*/
	...
	println "constructed AsciidocTemplateEngine2 - ready to render()"
    ...
    println "writing file resources/AsciidocTemplateEngine2Results.html"
    new File("resources/AsciidocTemplateEngine2Results.html").write(txt.toString());

    System.out.println("--- End Of Text For AsciidocTemplateEngine2 ---");    
    } // end of main
...
try{   Script scriptObject = InvokerHelper.createScript(script.getClass(), binding); 
                    PrintWriter pw = new PrintWriter(writer);
                    scriptObject.setProperty("out", pw);
                    scriptObject.run();
                    pw.flush();
}catch(Exception x ) {println "bad news:"+x.message}
                    return writer;
                } // end of writeTo
      ...
      {
            sw.write("\"\"\");\n");
            sw.write("\n/* Generated by AsciidocTemplateEngine2 */");
        } // end of endScript
