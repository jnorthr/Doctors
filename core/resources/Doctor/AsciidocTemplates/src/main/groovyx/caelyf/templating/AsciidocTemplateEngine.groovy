...
-- */
		payloadText = reader.getText();
		println "parse(reader) found size of ${payloadText.size()} bytes";

            return payloadText;   //writer.toString();
