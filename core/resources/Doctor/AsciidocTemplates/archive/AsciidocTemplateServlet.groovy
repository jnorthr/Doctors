...
/**
 * The Asciidoc template servlet extends Groovy's own template servlet
 *
 ...
 */
class AsciidocTemplateServlet extends TemplateServlet {

    @Override
    void init(ServletConfig config) {
        super.init(config)
	  println "AsciidocTemplateServlet.init()"
    }
...
println "AsciidocTemplateServlet.service()"
