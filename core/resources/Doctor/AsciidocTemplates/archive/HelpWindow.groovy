...
* help files; this is a trial bit of code and is not part of the app
*/
import java.io.*;
...
*/
public HelpWindow(String fileurl) 
{
    super(fileurl);
    def uri = fileurl.toURL();
    println "[${uri}]"
    helpURL = ClassLoader.getSystemResource("resources/sample.html"); //this.getClassLoader().getResource(fileurl);
    println "[${helpURL}]"
...
public static void main(String [] args){
    String fn = "file:\\\\\\C:\\Software\\Groovy\\AsciidocTemplates\\AsciidocTemplates\\resources\\sample.html";
