 ...
 * This pre-processor handles the groovy GString replacement syntax ${..} and JSP style tags to 'include' external text
 * fragments. It does NOT do any JSP tags
 *
 ...
 * are re-written to the output stream. They are NOT consumed.
 *
